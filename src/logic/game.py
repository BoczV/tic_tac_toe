...
class Game:
    ...
    def setup_players(self) -> None:
        if self.__game_mode == "a":
            ...
            self.__first_player = Robot(first_player_char, first_robot_name, difficulty_level1, self.__needed_part_of_alphabet, self.__menu, "robot")
            self.__second_player = Robot(second_player_char, second_robot_name, difficulty_level2, self.__needed_part_of_alphabet, self.__menu, "robot")
